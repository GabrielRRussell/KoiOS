...
C_SOURCES = $(wildcard kernel/*.c kernel/memory/*.c cpu/interrupts/*.c cpu/timer/*.c cpu/*.c drivers/ata/*.c drivers/keyboard/*.c drivers/screen/*.c drivers/serial/*.c drivers/fs/fat32/*.c libk/mem/*.c libk/string/*.c)
HEADERS = $(wildcard kernel/*.h kernel/memory/*.h cpu/interrupts/*.h cpu/timer/*.h cpu/*.h drivers/ata/*.h drivers/keyboard/*.h drivers/screen/*.h drivers/serial/*.h drivers/fs/fat32/*.h libk/mem/*.h libk/string/*.h)
